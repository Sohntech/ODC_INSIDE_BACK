...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Address of the learner' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], CreateLearnerDto.prototype, "address", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Gender of the learner', enum: ['MALE', 'FEMALE'] }),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Referential ID the learner is associated with' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], CreateLearnerDto.prototype, "refId", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Promotion ID the learner belongs to' }),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
...
], CreateLearnerDto.prototype, "addToWaitlist", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({
        enum: client_1.LearnerStatus,
        description: 'Initial status for the learner',
        default: client_1.LearnerStatus.ACTIVE
    }),
